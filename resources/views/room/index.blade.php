                        ...
                        @if($data)
                                @foreach($data as $d)
                                        ...
                                        <td>
                                            ...
                                            <a onclick="return confirm('Are you sure to delete this data?')" href="{{url('admin/room/'.$d->id).'/delete'}}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>            
                                @endforeach
                         @endif
